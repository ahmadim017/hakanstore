...
<body style="background-color: #e2e8f0;">
    ...
    <nav class="navbar navbar-expand-md fixed-top navbar-dark bg-dark text-white mb-5" style="background-color: #171d26!important;">
        <a href="/" class="navbar-brand font-weight-bold"><i class="fa facarrot"></i>Hakan STORE</a>
...
data-toggle="dropdown" aria-haspopup="true"
            ...
            <div class="mx-2 my-auto d-inline" style="width: 45%">
                <div class="input-group">
                    <input type="text" class="form-control border border-right0" placeholder="Search...">
        ...
        <ul class="nav navbar-nav navbar-right ml-auto">
                ...
                <div>
                    <li class="nav-item ml-3 mr-3">
                        <a href="" class="btn btn-md shadow btn-outline-dark btn-block" style="color: #333;background-color: #fff;border-color: #fff;">
                            <i class="fa fa-shopping-cart"></i> 0 | 0</a>
                    </li>
                </div>
                <!-- end cart --> 
                ...
                <ul class="navbar-nav d-none d-md-block ml-4">
                    <li class="nav-item dropdown">
                       ...
                       <div class="dropdown-menu border-0 shadow" arialabelledby="navbarDropdown">
               ...
               @else
               <li class="nav-item">
                   <a href="/customer/login" class="btn btn-md shadow btnoutline-dark btn-block" style="color:#fff;background-color:#343a40;border-color: #343a40;">
